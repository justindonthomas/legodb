...
------------------
*/
#1) INDEX ON set_contents: This is a good choice for an index because there is a large amount of data and the table uses a compound key comprised of 3 foreign keys.
